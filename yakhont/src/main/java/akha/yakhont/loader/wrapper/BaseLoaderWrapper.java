...
public abstract class BaseLoaderWrapper<D> {
    ...
    private Callable<? extends BaseViewModel<D>>            mBaseViewModel;
    ...
    /**
     * Sets {@code BaseViewModel} component.
     *
     * @param baseViewModel
    ...
    public BaseLoaderWrapper<D> setSwipeRefreshWrapper(final SwipeToRefreshWrapper swipeRefreshWrapper) {
        mSwipeToRefreshWrapper = swipeRefreshWrapper;
        return this;
    }
    ...
    /**
     * The <code>SwipeToRefreshWrapper</code> class is intended to support "swipe refresh" feature.
     * To enable swipe refresh, activity (or fragment) should contain {@link SwipeRefreshLayout}
    ...
    public static class SwipeToRefreshWrapper<D> {
        ...
        /**
         * Enables "swipe refresh" feature for the given activity.
         *
         * @param resId
        ...
        public static <E, D> boolean register(@IdRes final int resId, final CoreLoad<E, D> coreLoad) {
            return register(null, resId, coreLoad.getLoaders());
        }
        ...
        public static boolean register(final Activity activity, @IdRes final int resId,
            ...
            return register(activity, resId, baseLoaderWrappers, null);
        }
            ...
            if (baseLoaderWrapper == null)
                ...
                if (swipeRefreshLayout == null)
                    ...
                    if (!(swipeRefreshLayout instanceof SwipeRefreshLayout))
                        ...
                        onRefreshListener.mSwipeRefreshWrapper = swipeToRefreshWrapper;

                        ViewHelper.setTag(swipeRefreshLayout, ID_SWIPE_LAYOUT,
                                new WeakReference<SwipeToRefreshWrapper>(swipeToRefreshWrapper));
        ...
        private static class OnRefreshListenerHelper<D> implements OnRefreshListener {
            ...
            private       SwipeToRefreshWrapper<D>          mSwipeRefreshWrapper;
        ...
        public static void onPauseOrResume(@NonNull final Activity activity, final boolean resume) {
            for (final View view: findViews(activity)) {
                ...
                final WeakReference<SwipeToRefreshWrapper> weakReference =
                        (WeakReference<SwipeToRefreshWrapper>) view.getTag(ID_SWIPE_LAYOUT);
                if (weakReference == null) return;

                final SwipeToRefreshWrapper wrapper = weakReference.get();
                if (wrapper == null)
    ...
    public static class LoadParameters implements Parcelable {
        ...
        public  static final LoadParameters       NO_LOAD                 =
                new LoadParameters.Builder().setNoLoad(true).create();
         ...
         *
         * @param noLoad
         *        {@code true} to just init without real data loading, {@code false} otherwise
         */
        @SuppressWarnings("WeakerAccess")
        public LoadParameters(final String  loaderId, final Integer timeout, final boolean forceCache,
                              ...
                              final boolean sync, final boolean handleTimeout, final boolean noLoad) {
            mLoaderId       = loaderId;
            ...
            CoreLogger.log("loader ID: " + loaderId + ", force cache: " + forceCache +
                    ...
                    ", noLoad: " + mNoLoad + ", timeout (ms): " + mTimeout);
        ...
        public static class Builder {
            ...
            @SuppressWarnings({"unused", "WeakerAccess"})
            public Builder setNoLoad(final boolean noLoad) {
                mNoLoad         = noLoad;
                return this;
            }
            ...
            public LoadParameters create() {
                return new LoadParameters(mLoaderId, mTimeout, mForceCache, mNoProgress, mMerge,
                        mNoErrors, mSync, mHandleTimeout, mNoLoad);
            }
        }
    }
}
