...
public abstract class BaseLoaderWrapper<D> {
     ...
     */
    @SuppressWarnings({"WeakerAccess", "UnusedReturnValue"})
    public BaseLoaderWrapper<D> setBaseViewModel(final Callable<BaseViewModel<D>> baseViewModel) {
    ...
    /**
     * The <code>SwipeRefreshWrapper</code> class is intended to support "swipe refresh" feature.
